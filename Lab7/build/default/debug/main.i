...
STATE0: ; Rua A: Verde (6s) | Rua B: Vermelho
    MOVLW 0x21 ; ((PORTD) and 07Fh), 0 (Verde A) e ((PORTD) and 07Fh), 5 (Vermelho B) [cite: 144, 189]
    MOVWF PORTD
...
STATE1: ; Rua A: Amarelo (3s) | Rua B: Vermelho
    MOVLW 0x22 ; ((PORTD) and 07Fh), 1 (Amarelo A) e ((PORTD) and 07Fh), 5 (Vermelho B) [cite: 145, 192]
    MOVWF PORTD
...
STATE2: ; Rua A: Vermelho | Rua B: Verde (6s)
    MOVLW 0x0C ; ((PORTD) and 07Fh), 2 (Vermelho A) e ((PORTD) and 07Fh), 3 (Verde B) [cite: 146, 195]
    MOVWF PORTD
    MOVLW 60 ; 60 x 0.1s = 6 segundos [cite: 305]
    CALL DELAY_VAR
    MOVLW 3
...
STATE3: ; Rua A: Vermelho | Rua B: Amarelo (3s)
    MOVLW 0x14 ; ((PORTD) and 07Fh), 2 (Vermelho A) e ((PORTD) and 07Fh), 4 (Amarelo B) [cite: 147, 198]
    MOVWF PORTD
    MOVLW 30 ; 30 x 0.1s = 3 segundos [cite: 305]
    CALL DELAY_VAR
