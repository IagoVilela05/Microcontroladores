...
# \* \*\*Lógica de Borda:\*\* Uso da variável `LAST\_STATE` para detectar a borda de subida (\*Rising Edge\*), garantindo que o contador só mude uma vez por clique.
...
# > \*\*⚠️ Nota de Hardware:\*\* Ao testar na \*\*EasyPIC6\*\*, certifique-se de que as chaves DIP (SW9 para LEDs) estejam ligadas e que os jumpers de \*pull-up/pull-down\* dos botões estejam configurados conforme o manual `easypic6\_manual\_v100.pdf`.
